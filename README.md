...
The `default` layout uses the same structure. [See Example](https://github.com/Byongho96/react-responsive-3d-carousel/tree/main/src/utils/getCarouselIndex.ts).
...
export type LayoutInfo = {
  width?: number | string // proportional to container width if a number. When it's undefined or 'auto', the width prop is used.
  height?: number | string // proportional to container height if a number. When it's undefined or 'auto', the height prop is used.
  translate: {
