...
| depth                   | number                     | 2                        | The 3D Depth of carousel <br/> A value between `1` to `3` is recommended |
...
Here's [contributing guide](https://github.com/Byongho96/react-responsive-3d-carousel) contains details on how to setup dev environment.
