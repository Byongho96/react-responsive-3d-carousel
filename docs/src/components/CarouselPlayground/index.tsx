...
const items = [
  ...
  <video src={sampleVideoSrc} autoPlay loop />,
...
export default function CarouselPlayground(): JSX.Element {
  ...
  const [boxShadow, setBoxShadow] = useState('0 0.1rem 0.5rem rgba(0, 0, 0, 0.5)');
    ...
    <div>
      ...
      <div className={`pico ${styles['form-container']}`}>
        <details open>
          ...
          <InputItem name="box-shadow" label="Box Shadow" value={boxShadow} setValue={setBoxShadow} />
